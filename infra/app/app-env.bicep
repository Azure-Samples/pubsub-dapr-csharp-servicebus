...
param manegeIdentityClientId string
...
resource daprComponentPubsub 'Microsoft.App/managedEnvironments/daprComponents@2022-06-01-preview' = {
  ...
  properties: {
    ...
    metadata: [
      {
        name: 'azureClientId'
        value: manegeIdentityClientId  // See https://docs.dapr.io/developing-applications/integrations/azure/authenticating-azure/#credentials-metadata-fields for MSI
      }
      {
